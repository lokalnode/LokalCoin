...
official/supported Docker Images found at https://hub.docker.com/r/lokalpay/lokald/
...
**NOTE: Please update the image description at https://hub.docker.com/r/lokalpay/lokald-develop/ when changing the above text**
