...
Below are some notes on how to build Lokal Coin for Windows.
...
way. This will install to `c:\workspace\lokal`, for example:

    make install DESTDIR=/mnt/c/workspace/lokal
