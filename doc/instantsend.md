...
This mechanism has been integrated into Bitcore-Node-Lokal which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/lokalpay/insight-api-lokal#web-socket-api](https://github.com/lokalpay/insight-api-lokal#web-socket-api)
* API: [https://github.com/lokalpay/insight-api-lokal#instantsend-transactions](https://github.com/lokalpay/insight-api-lokal#instantsend-transactions)
