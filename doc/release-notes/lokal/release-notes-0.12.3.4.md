...
When deployed on testnet, it is required to start with a fresh data directory or call Lokal Coin with `-reindex-chainstate`.

0.12.3.4 Change log
===================

See detailed [set of changes](https://github.com/lokalpay/lokal/compare/v0.12.3.3...lokalpay:v0.12.3.4).
