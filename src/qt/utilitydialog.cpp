    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  lokal-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the LOKAL_Coin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 LOKAL, 0.01 LOKAL, 0.1 LOKAL, 1 LOKAL and 10 LOKAL -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a href=\"https://docs.lokal.org/en/stable/wallets/lokalcore/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
