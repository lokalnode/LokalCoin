    ...
    transactionView(0), abandonAction(0), columnResizingFixer(0)
{
    ...
    instantsendWidget->addItem(tr("Locked by InstaLOKAL"), TransactionFilterProxy::InstantSendFilter_Yes);
    instantsendWidget->addItem(tr("Not locked by InstaLOKAL"), TransactionFilterProxy::InstantSendFilter_No);
...
void TransactionView::setModel(WalletModel *_model)
{
    ...
    if(_model)
    {
        ...
        transactionView->setColumnWidth(TransactionTableModel::InstaLOKAL, INSTANTSEND_COLUMN_WIDTH);
...
void TransactionView::showAddressQRCode()
{
    ...
    dialog->setInfo(tr("QR code"), "lokal:"+strAddress, "", strAddress);
    dialog->show();
}
