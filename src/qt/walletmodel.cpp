...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, const CCoinControl& coinControl)
{
    ...
    for (const SendCoinsRecipient &rcp : recipients)
    {
        ...
        {   // User-entered lokal address / amount:
...
WalletModel::SendCoinsReturn WalletModel::sendCoins(WalletModelTransaction &transaction)
{
...

    {
        ...
        for (const SendCoinsRecipient &rcp : recipients)
        {
            ...
            else if (!rcp.message.isEmpty()) // Message from normal lokal:URI (lokal:XyZ...?message=example)
            {
...
WalletModel::UnlockContext WalletModel::requestUnlock(bool fForMixingOnly)
{
    ...
    bool was_mixing = (encStatusOld == UnlockedForStakingOnly);
    ...
    bool fMixingUnlockFailed = fForMixingOnly && !(encStatusNew == UnlockedForStakingOnly);
