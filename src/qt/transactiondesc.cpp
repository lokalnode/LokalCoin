...
QString TransactionDesc::FormatTxStatus(const CWalletTx& wtx)
{
    ...
    else
    {
        ...
        if (wtx.IsLockedByInstaLOKAL()) {
            strTxStatus += " (" + tr("verified via LLMQ based InstaLOKAL") + ")";
        }
...
QString TransactionDesc::toHTML(CWallet *wallet, CWalletTx &wtx, TransactionRecord *rec, int unit)
{
    ...
    // Message from normal lokal:URI (lokal:XyZ...?message=example)
    ...
    if (wtx.IsCoinBase())
    {
        quint32 numBlocksToMaturity = 61;
