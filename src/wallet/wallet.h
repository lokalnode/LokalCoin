...
static const CAmount DEFAULT_FALLBACK_FEE = 0.00001 * COIN;
//! -m_discard_rate default
static const CAmount DEFAULT_DISCARD_FEE = 10000;
//! -mintxfee default
static const CAmount DEFAULT_TRANSACTION_MINFEELEGACY = 50 * COIN;
static const CAmount DEFAULT_TRANSACTION_MINFEE = 0.00001 * COIN;
...
public:
    ...
    bool IsLockedByInstaLOKAL() const;
...
public:
    ...
    /// Get 1000LOKAL output and keys which can be used for the Masternode
    ...
    bool CreateCoinStake(const CKeyStore& keystore, unsigned int nBits, CAmount blockReward, CMutableTransaction& txNew, unsigned int& nTxNewTime, std::vector<const CWalletTx *> &vwtxPrev);
