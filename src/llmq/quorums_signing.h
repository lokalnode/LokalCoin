...
#ifndef LOKAL_QUORUMS_SIGNING_H
#define LOKAL_QUORUMS_SIGNING_H
...
public:
    ...
    // This is the case for example when a signature appears as part of InstaLOKAL or ChainLocks
    ...
    // mechanism prevents possible conflicts. As an example, ChainLocks prevent conflicts in confirmed TXs InstaLOKAL votes
